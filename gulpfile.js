...
function parsePath() {
  return through.obj(function (file, enc, cb) {
    modulePath = path.relative(path.join(file.cwd, file.base), file.path)
...
gulp.task('component',['searchPath'], (cb) => {
  ...
  console.log('sourcePath ', modulePath);

  //let modulePathMinusOneSubDir = modulePath.pathMinusOneSubDir();
  //console.log('modulePathMinusOneSubDir ',modulePathMinusOneSubDir);
